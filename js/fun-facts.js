const funFactsOceans = [
  ...
  { isOceans: false, fact: "The deepest ocean is the Atlantic Ocean." },
...
const funFactsFish = [
  ...
  { isFish: true, fact: "Fish don't sleep the same way land mammals do, they rest." },
  { isFish: true, fact: "Fish are cold blooded animals." },
